...
screen progressmod ():
    ...
    vbox:
        ...
        text ("Chap. [current_chapter]") style "mod"
        text ("Day [totaldays]") style "mod"
        text ("") style "mod"

        textbutton _("Main:") action ShowMenu("maintrackerch" + str(current_chapter) + "m") style "event_button" text_style "mod"
        text ("[MainEvent.points]/[MainEvent.current_max]") style "mod"
        text ("") style "mod"

        textbutton _("Happy:") action ShowMenu("secrettrackerm") style "event_button" text_style "mod"
        if happymiss < 1:
            text ("[HappyEvent.points]/[HappyEvent.current_max]") style "mod"
        else:
            text ("[HappyEvent.points]/[HappyEvent.current_max] {color=#FF0000}([happymiss]){/color}") style "mod"
        text ("") style "mod"

        text ("Playtime") style "mod"
        ...
        text "[pt_hours]:[pt_minutes]" style "mod"
...
# Names Column (linking to their event trackers)
    ...
    vbox:
        ...
        if Io.active:
            textbutton _("Io") action [ShowMenu("amitrackerm2"), SetVariable("showgirl", "Io")] style "event_button" text_style "iomod"
        if Kaori.active:
        ...
        if Touka.active:
            textbutton _("Touka") action [ShowMenu("amitrackerm2"), SetVariable("showgirl", "Touka")] style "event_button" text_style "toukamod"
        if Tsubasa.active:
            textbutton _("Tsubasa") action [ShowMenu("amitrackerm2"), SetVariable("showgirl", "Tsubasa")] style "event_button" text_style "tsubasamod"
        if Tsukasa.active:
        ...
        if Yuki.active:
            textbutton _("Yuki") action [ShowMenu("amitrackerm2"), SetVariable("showgirl", "Yuki")] style "event_button" text_style "yukimod"
        if Yumi.active:
    ...
    vbox:
        ...
        if Io.active:
            if Io.next_love > 0 and show_next:
                text ("[io_love] ([Io.next_love])") style "iomod"
            else:
                text ("[io_love]") style "iomod"
        if Kaori.active:
        ...
        if Touka.active:
            if Touka.next_love > 0 and show_next:
                text ("[touka_love] ([Touka.next_love])") style "toukamod"
            else:
                text ("[touka_love]") style "toukamod"
        if Tsubasa.active:
            if Tsubasa.next_love > 0 and show_next:
                text ("[tsubasa_love] ([Tsubasa.next_love])") style "tsubasamod"
            else:
                text ("[tsubasa_love]") style "tsubasamod"
        if Tsukasa.active:
        ...
        if Yuki.active:
            if Yuki.next_love > 0 and show_next:
                text ("[yuki_love] ([Yuki.next_love])") style "yukimod"
            else:
                text ("[yuki_love]") style "yukimod"
        if Yumi.active:
    ...
    vbox:
        ...
        if Io.active:
            if Io.next_lust > 0 and show_next:
                text ("[io_lust] ([Io.next_lust])") style "iomod"
            elif Io.lust_active:
                text ("[io_lust]") style "iomod"
            else:
                text ("N/A") style "mod"
        if Kaori.active:
        ...
        if Touka.active:
            if Touka.next_lust > 0 and show_next:
                text ("[touka_lust] ([Touka.next_lust])") style "toukamod"
            elif Touka.lust_active:
                text ("[touka_lust]") style "toukamod"
            else:
                text ("N/A") style "mod"
        if Tsubasa.active:
            if Tsubasa.next_lust > 0 and show_next:
                text ("[tsubasa_lust] ([Tsubasa.next_lust])") style "tsubasamod"
            elif Tsubasa.lust_active:
                text ("[tsubasa_lust]") style "tsubasamod"
            else:
                text ("N/A") style "mod"
        if Tsukasa.active:
        ...
        if Yuki.active:
            if Yuki.next_lust > 0 and show_next:
                text ("[yuki_lust] ([Yuki.next_lust])") style "yukimod"
            elif Yuki.lust_active:
                text ("[yuki_lust]") style "yukimod"
            else:
                text ("N/A") style "mod"
        if Yumi.active:
...
# Events Column
    vbox:
        ...
        if Io.active and iomiss < 1:
            text ("[iopoint]/[Io.current_max]") style "iomod"
        ...
        if Touka.active and toukamiss < 1:
            text ("[toukapoint]/[Touka.current_max]") style "toukamod"
        ...
        if Tsubasa.active and tsubasamiss < 1:
            text ("[tsubasapoint]/[Tsubasa.current_max]") style "tsubasamod"
        ...
        if Yuki.active and yukimiss < 1:
            text ("[yukipoint]/[Yuki.current_max]") style "yukimod"
...
# Options Column
    vbox:
        ...
        textbutton _("Options") action ShowMenu("mod_options") text_style "mod"
