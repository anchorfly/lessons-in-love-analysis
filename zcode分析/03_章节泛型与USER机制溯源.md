...
|---|---|---|---|
| **USER1** | AmiEvents.rpy:5170（amidate50p4 结尾）；script.rpy:36689-36690（enterusername 查询） | Ami 深夜约会的结尾：Ami 问 "Do you believe in God?" 后两人坐上**倒着开的公交**回家，屏幕打出 "USER1 HAS SUCCESSFULLY LOGGED IN" | 与 **Ami** 绑定；day220 终端查询时 "USER1 IS OFFLINE AND CAN NOT ACCEPT YOUR REQUEST"——已离线 |
| **USER2** | ch2script.rpy:16522（dormwar14）、20087-20110（thirdreset1/2）、21010-21011、30745（secondbeach15）；script.rpy:29974-29979（halloween4）、30784-30794（halloween6）、33898（trinity3 内 Sensei 发问）、36707-36748（enterusername/enteryourpass）；DormEvents.rpy:15298（mikudorm30）、30052-30071（roomwithclocks）；KaoriEvents.rpy:2641（kaoridate20）；inappropriatecontent.rpy:17340；chap4.rpy:20494-20544（halloweenfive13/14） | 出场最多、贯穿二至四章。自称守护者："YOU DO NOT KNOW ME, BUT I HAVE WATCHED YOU GROW… I AM HERE TO PROTECT YOU. ALL YOU MUST DO IS ACCEPT ME."（ch2script.rpy:20098-20106）；曾借雨天网络连入救下 Miku（DormEvents.rpy:15298-15302）；常驻 Sensei 侧（"YOU ARE NOW SHARING YOUR SCREEN WITH USER2"，ch2script.rpy:21011）；Sensei 本人也直接问过 Maya 这些 "USER2 stuff" 是什么（script.rpy:33898），Maya 装傻 | 权限受限：三度 "LACKS THE PERMISSIONS NECESSARY TO RESET SYSTEM"（script.rpy:30788/30793）；在 Kaori 万圣节线 "REWRITING KEY EVENTS… USER2 HAS LEFT"（script.rpy:29974-29979）；**第四章万圣节 halloweenfive13/14：HOPE 回归（"GUESS WHO'S BACK"）后 USER2 连接杀毒失败，被 3,485,215,296,256,781 个未授权连接压垮，"UNABLE TO DETACH ITSELF FROM HOST BODY"→被感染→"USER2 has been removed!"（chap4.rpy:20536-20544）** |
| **USER3** | script.rpy:34092（trinity3 结尾）；script.rpy:36694-36698（enterusername 查询被拒） | trinity3 末尾接管 Terminal 23；全小写、情感化（"can you see this?" → "i'm so glad / i was very concerned"），**主动向屏幕外的玩家确认可见性** | 接管后拒绝一切外部连接请求（"CONNECTION HAS BEEN REJECTED"）；接管时点恰在 Maya"死亡"/day214 世界异常之前，与 beachwars18 中 pareidolia 的 "it is my turn" 宣言相呼应 |
| **USER4** | NaoEvents.rpy:2454（naocamp2）；chap4.rpy:20502（halloweenfive13）；script.rpy:36701-36703（enterusername） | Nao（不能说话的女孩）事件中系统崩溃："AN UNHANDLED EXCEPTION… TEMPLATE9 CAN NOT BE LOCATED… **RESTORING BACKUP FROM "USER4"**… TEMPLATE9 HAS BEEN RESTORED"——Nao 的世界是 **TEMPLATE9**，由 USER4 的备份恢复 | 身份可疑：USER2 的杀毒日志插播 "IF YOU TRUST "USER4" PLEASE DISREGARD THIS MESSAGE"（chap4.rpy:20502）——暗指 USER4 可能就是木马/新管理员账户源头；终端查询显示 "USER4 IS A RESERVED ADDRESS"（保留地址，玩家不能连） |
...
1. **世界=Terminal 23 上运行的多用户应用**。角色是模板（Nao=TEMPLATE9），各女孩脑内有实体（Molly 的 Siobhan），神（HOPE/Arramin/Hal…）是有"办公室"和"档案"的外部管理员，USER1-4 是账户，玩家是其中之一（"SHARING YOUR SCREEN"）。
2. **重置链条**：
   ...
   - **关键权限结构**：USER2 三次想 reset 都 "LACKS THE PERMISSIONS"（script.rpy:30788/30793）——它必须由**玩家输入系统密码授权**才能 "ASSUME CONTROL"。换言之**玩家=SYSTEM ADMINISTRATOR**（所有报错都让你 "CONTACT YOUR SYSTEM ADMINISTRATOR"），重置的最终许可权在屏幕外。
